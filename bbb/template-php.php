...
<html xmlns = "http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Welcome - Bromley by Bow Health Centre</title>
	...
	<body>
		<div id="holder">
			...
			<div id="bodyholder">
				...
				<div id="content">
									<div class="directory"> <a href="home.html">Home</a> <div class="arrow"></div> Template-php </div> <!-- Close directory div -->
				...
				<div id="rightbar">
					...
					<div id="times">
						<script src="../javascript/rightbarinfo-bbb.js"></script>
					</div>
