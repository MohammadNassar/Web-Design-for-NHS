...
<html xmlns = "http://www.w3.org/1999/xhtml">
	<head>
		<title>Contact Us - Bromley by Bow Health Centre</title>
		<link type="text/css" href="style-default.css" rel="stylesheet"></link>
		<style>#stafftimestable tr{height: 50px;} #stafftimesview{width: 500px;}</style>
	</head>
	<body onload="document.getElementById('name').focus();">
		<div id="holder">
			...
			<div id="bodyholder">
				...
				<div id="content">
									<div class="directory"> <a href="home.html">Home</a> <div class="arrow"></div> Staff Availability Times <span style="float:right;font-weight:bold;"><a href="stafftimes.html">Update Times</a></span></div> <!-- Close directory div -->
					<center>
						
						<b>Shah Ahmed</b>
						<?php $filename = 'ahmeds.txt'; $readfile = fopen($filename, 'r'); $show = fread($readfile, filesize($filename)); fclose($readfile); echo "$show"; ?>
						<br /><br />
						
						<b>Emma Cassells</b>
						<?php $filename = 'cassellse.txt'; $readfile = fopen($filename, 'r'); $show = fread($readfile, filesize($filename)); fclose($readfile); echo "$show"; ?>
						<br /><br />
						
						<b>Ian Jackson</b>
						<?php $filename = 'jacksoni.txt'; $readfile = fopen($filename, 'r'); $show = fread($readfile, filesize($filename)); fclose($readfile); echo "$show"; ?>
						<br /><br />
